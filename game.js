...
function update(dt) {
  ...
  // Garantía: si el azar no lo soltó y el nivel está por terminar, forzarlo
  if (!powerupSpawnedThisLevel && asteroids.length > 0 && asteroids.length <= 2) {
